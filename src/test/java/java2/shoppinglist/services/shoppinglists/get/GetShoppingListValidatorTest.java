...
public class GetShoppingListValidatorTest {

    @Mock
    private ShoppingListRepository shoppingListRepository;

    @InjectMocks
    private GetShoppingListValidator validator =  new GetShoppingListValidator();

    private User user = new User();
    private GetShoppingListRequest request = new GetShoppingListRequest(user, "title");
